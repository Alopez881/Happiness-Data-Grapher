...
def read_gdp_data(happy_dict):
    ...
    for line in file:
        ...
        #This skips the line if the population is less than 100 million
        if float(pop_in_mil) < 100:
                continue
        else:
            #This prints the country, population, GDP, and happyiness index
            print(country + "," + pop_in_mil + "," + GDP + "," + happy_index)
    return country, pop_in_mil, GDP
...
# Function prints all the values in a dictionary happy_dict sorted by key
