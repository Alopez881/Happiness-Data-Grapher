...
def make_happy_dict():
    ...
    #This FOR loop goes though each country in the dictionary and prints the country with happiness index 
    for country in happy_dict:
        #This printst the country and country happiness index
